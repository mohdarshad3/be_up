angular.module('Front').service('adminService', function ($http, $q, $localStorage,CONFIG,Upload) {
  return {
    ...
    getProductList: function (page, callback) {
      $http({
        method: 'GET',
        url: CONFIG.baseUrl + 'admin/getProductList/' + page
      }).success(function (result) {
        callback(null, result);
      }).error(function (err) {
        callback(true, err);
    ...
    getOtherProductList: function (page,userId, callback) {
      $http({
        method: 'GET',
        url: CONFIG.baseUrl + 'admin/getOtherProductList/' + page + '/' + userId
      }).success(function (result) {
        callback(null, result);
      }).error(function (err) {
        callback(true, err);
    ...
    getPostList: function (page, callback) {
      $http({
        method: 'GET',
    ...
    generalPostList: function (page, callback) {
      $http({
        method: 'GET',
        url: CONFIG.baseUrl + 'admin/getPostList_new/' + page
      }).success(function (result) {
        callback(null, result);
      }).error(function (err) {
        callback(true, err);
    ...
    othersGeneralPost: function (page,userId, callback) {
      $http({
        method: 'GET',
        url: CONFIG.baseUrl + 'admin/othersGeneralPost/' + page + '/' + userId
      }).success(function (result) {
        callback(null, result);
      }).error(function (err) {
        callback(true, err);
